...
geodesic distance
: the shortest path between two nodes; by definition, not a trail or walk because repeated segments wouldn't be the shortest; with binary data, the number of steps; with weighted data, might be a sum or some other calculation of "effort"
...
: a triad where (5 of 16 possibilities)

intransitive triad
: a triad where (7 of 16 possibilities)

transitive triad
: a triad where (4 of 16 possibilities)

xxx see https://corescholar.libraries.wright.edu/cgi/viewcontent.cgi?article=2427&context=knoesis
