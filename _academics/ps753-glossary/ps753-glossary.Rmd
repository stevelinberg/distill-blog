...
node / vertex
: a junction in a network where two or more lines (edges) intersect; a dot connecting lines.<br>
...
snowball sample
: an entity group formed by starting with one node and "rolling outwards" to its connections until all nodes or actors (in a limited set) are located
