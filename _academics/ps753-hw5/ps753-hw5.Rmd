...
Building on [last week's look](../ps753-hw3/index.html) at basic network centrality attributes in the Florentine Wedding dataset, we're going to look at two new measurements of centrality: brokerage and constraints.
