...
Although it's intended to be complete, and not overly technical where avoidable, it does assume a modest level of comfort using basic tools like RStudio and GitHub. If you're on Mac or Linux, you probably have [git](https://git-scm.com/) built in already, but you might need to install it if you're on Windows. That's outside the scope of this article, but you can find information about it on the main Git page.
